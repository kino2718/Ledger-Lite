...
**仕訳一覧** — 登録済みの仕訳を仕訳帳スタイルで表示します。各仕訳から編集・削除できます。
...
**総勘定元帳（科目一覧）** — 科目を選んで元帳を表示します。各科目の現在残高も一覧できます。
...
ダッシュボード表示・仕訳の入力・一覧・編集・削除・総勘定元帳・試算表までを
実装しています。
...
- 残高・損益・元帳・試算表の集計ロジック、仕訳入力の検証ロジック

未実装（今後の予定）:

- 会計期間・決算（期首繰越、期間で絞った帳簿・レポート）
